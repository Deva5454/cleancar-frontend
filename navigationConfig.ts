...
export const NAV_CONFIG: NavItem[] = [
  ...
  // CRM - Customer relationship management
  {
    ...
    module: "crm",
    match: "prefix",
    description: "Fleet accounts for offices and housing societies",
  },
  {
    label: "CRM",
    path: "/crm",
  ...
  // HR & PEOPLE - People management
  {
    ...
    children: [
      ...
      { label: "Shift Roster", path: "/hr", icon: Calendar, module: "hr", match: "exact" },
      ...
      { label: "Onboarding Checklist", path: "/hr/onboarding", icon: ClipboardList, module: "hr", match: "prefix" },
      { label: "Employee Lifecycle", path: "/hr/lifecycle-management", icon: GitCompare, module: "hr", match: "prefix" },
      { label: "Statutory Forms — Onboarding", path: "/hr/statutory-forms-onboarding", icon: Upload, module: "hr", match: "prefix" },
      { label: "Statutory Forms — Verification", path: "/hr/statutory-forms-verification", icon: ShieldCheck, module: "hr", match: "prefix" },
      { label: "Leave Policy Engine", path: "/hr/leave-policy-engine", icon: Scale, module: "hr", match: "prefix" },
      { label: "ID Card Generator", path: "/hr/id-card-generator", icon: IdCard, module: "hr", match: "prefix" },
      { label: "Holiday Calendar", path: "/hr/holiday-management", icon: CalendarDays, module: "hr", match: "prefix" },
      { label: "HR Approval Center", path: "/hr/approval-center", icon: ClipboardCheck, module: "hr", match: "prefix" },
      { label: "HR Payroll Approval", path: "/hr/payroll-approval", icon: CheckSquare, module: "hr", match: "prefix" },
      ...
      { label: "Expense Claims", path: "/claims", icon: Receipt, module: "hr", match: "prefix" },
      { label: "Investment Declaration", path: "/investment-declaration", icon: Landmark, module: "hr", match: "prefix" },
      { label: "Performance Management", path: "/performance-management", icon: Target, module: "hr", match: "prefix" },
  ...
  // PAYROLL - Payroll processing
  {
    ...
    children: [
      ...
      { label: "Salary Assignment", path: "/payroll/salary-assignment", icon: User, module: "payroll", match: "prefix" },
