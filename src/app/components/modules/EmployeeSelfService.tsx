          ...
          {isHR && (
            <div className="flex-1 min-w-[250px]">
              ...
              <Select value={selectedEmployee} onValueChange={setSelectedEmployee}>
                ...
                <SelectContent>
                  {(employeeDatabaseService.getAll().length > 0 ? employeeDatabaseService.getAll().map(e => ({ id: e.id || e.tempId, name: e.fullName, empCode: e.empCode || e.id || e.tempId })) : MASTER_EMPLOYEES).map((emp) => (
