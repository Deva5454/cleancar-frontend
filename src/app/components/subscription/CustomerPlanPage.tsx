  ...
  return (
    <div ref={scrollRef} className="cpp-root" style={{minHeight:"100vh",background:"linear-gradient(160deg,#f0f4ff 0%,#faf5ff 35%,#f0fdff 70%,#fefce8 100%)"}}>
      ...
      <div style={{background:"white",borderBottom:"1px solid #e2e8f0",display:"flex",justifyContent:"center"}}>
        ...
        <button onClick={() => setPageMode("cancel")} style={{padding:"14px 32px",fontWeight:700,fontSize:14,border:"none",cursor:"pointer",borderBottom:pageMode==="cancel"?"3px solid #312e81":"3px solid transparent",color:pageMode==="cancel"?"#312e81":"#64748b",background:"none"}}>Cancel Service</button>
      </div>
