...
export function FinanceTransactions() {
  ...
  // honest empty state if both stores are empty — no mock data is ever shown.
  function buildLiveTransactions(cityName: string): FinanceTransaction[] {
    ...
    // Previously fell back to getMockTransactions() when empty — that made a
    // fresh city look like it had real transaction history. An empty list is
    // the honest state; the UI shows a proper "no transactions yet" message.
    return all;
  }
