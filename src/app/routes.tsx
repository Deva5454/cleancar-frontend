...
export const router = createBrowserRouter([
  ...
  {
    path: "/buy",
    element: <ErrorBoundary><AppProviderSimple><Suspense fallback={<div style={{display:"flex",alignItems:"center",justifyContent:"center",height:"100vh"}}>Loading...</div>}><CustomerPlanPage /></Suspense></AppProviderSimple></ErrorBoundary>,
  },
  {
    path: "/book",
